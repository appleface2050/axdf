...
from app.models import SMSCodeSession
...
def sign_up(request):
    ...
    if request.method == 'GET':
        ...
        tel = request.GET.get("username", None)
        code = request.GET.get("code", None)
        password = request.GET.get("password",None)
        sms_cheat = request.GET.get("sms_cheat", False)
        # smscode = request.session.get('smscode', '1234')
        # if not code == smscode:
